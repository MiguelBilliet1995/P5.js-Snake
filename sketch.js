...
board.on('ready', function () {
  ...
  /*this.analogRead(0, function (voltage) {
    framert = map(voltage, 0, 255, 1, 5);
  });*/

  this.digitalRead(8, function (voltage) {
    if (s.yspeed !== 1) {
      console.log("up");
      s.dir(0, -1);
    }
  ...
  this.digitalRead(4, function (voltage) {
    if (s.yspeed !== -1) {
      console.log("down");
      s.dir(0, 1);
    }
  ...
  this.digitalRead(2, function (voltage) {
    if (s.xspeed !== 1) {
      console.log("left");
      s.dir(-1, 0);
    }
  ...
  this.digitalRead(7, function (voltage) {
    if (s.xspeed !== -1) {
      console.log("right");
      s.dir(1, 0);
    }
